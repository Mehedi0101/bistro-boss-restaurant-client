...
const Feature = () => {
    ...
    return (
        <div className="max-w-screen-2xl mx-auto min-h-[70vh] flex items-center">
            <div className="mx-5 md:mx-10 py-10 lg:p-10 xl:p-16" style={{ backgroundImage: `url(${featureBg})`, backgroundPosition: 'center', backgroundSize: 'cover' }}>
